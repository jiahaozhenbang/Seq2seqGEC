...
MODEL_DIR_STAGE1=outputs/baseline/stage1_large_bs_wo_smooth_patience10
...
cp bash/baseline_bea/train_stage1.sh $MODEL_DIR_STAGE1

# Transformer-base-setting stage 1

CUDA_VISIBLE_DEVICES=1 nohup python -u $FAIRSEQ_CLI_PATH/train.py $PROCESSED_DIR_STAGE1/bin \
