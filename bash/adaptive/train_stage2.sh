...
cp bash/adaptive/train_stage2.sh $MODEL_DIR_STAGE2
...
CUDA_VISIBLE_DEVICES=3 nohup python -u $FAIRSEQ_CLI_PATH/train.py $PROCESSED_DIR_STAGE2/bin \
    ...
    --keep-last-epochs 30 \
    --use-quality \
    --correct_probs_path preprocess/stage2_en/train0414.correct_probs.npz \
    --entropy_path preprocess/stage2_en/train0414.entropy.npz \
    --train_with_tn 1 \
